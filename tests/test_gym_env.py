...
from pynds.gym_env import PyNDSGymEnv, CustomPyNDSGymEnv
...
class TestPyNDSGymEnvInitialization:
    ...
    def test_init_gba_mode(self, mock_pynds_instance):
        ...
        mock_pynds_instance.get_frame.return_value = np.random.randint(0, 255, (160, 240, 4), dtype=np.uint8)
...
class TestCustomPyNDSGymEnv:
    ...
    def test_custom_reward_components(self, mock_pynds_instance):
        ...
        expected_components = ['total', 'memory', 'progress', 'survival', 'exploration', 'frame']
