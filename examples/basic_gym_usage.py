...
def basic_gym_example():
    """Demonstrate basic Gym environment usage."""
    ...
    while step < 100:  # Run for 100 steps
        ...
        print(
            f"Step {step}: Action={action} ({env.get_action_meanings()[action]}), "
...
def action_space_exploration():
    ...
    for action_type in action_types:
        ...
        env = PyNDSGymEnv(
            rom_path="game.nds", action_type=action_type, render_mode=None
        )
